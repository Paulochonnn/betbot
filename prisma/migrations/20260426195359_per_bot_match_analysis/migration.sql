/*
  ...
  - Added the required column `botId` to the `MatchAnalysis` table without a default value. This is not possible if the table is not empty.

*/
-- Vider le cache existant (les lignes n'ont pas de botId)
